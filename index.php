...
<head>
<title>PowerSchool Daily Bulletin Writer</title>
...
<?php include("sidebar.php"); ?>
  ...
  <div id="editor">
    ...
    <img src="images/ps_logo.png" id="ps_logo"/>

    <form method="post" action="show.php" target="_blank">

            <p>     
                <textarea name="content" cols="60" rows="30">Write and style your PowerSchool daily bulletins here.</textarea>    
            </p>
